...
- `Box.stl` — исходная модель коробки (не манифолд).  
  [![Box превью](Box.png)](Box.stl)
- `Box_fixed.stl` — автоматически исправленная версия (манифолд).  
  [![Box_fixed превью](Box.png)](Box_fixed.stl)
...
- Box_fixed.stl: 71.60 × 40.20 × 30.00; S≈17888.59; V≈16829.31; watertight: да
- Box.stl: 71.60 × 40.20 × 30.00; S≈17888.59; V≈16829.31; watertight: нет
...
Для печати используйте `Box_fixed.stl` — модель проверена как манифолдная. Исходный `Box.stl` оставлен для истории/сравнения.
