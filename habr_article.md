...
> При публикации на Хабре загрузите изображения: device_photos/photo.jpg (устройство), device_photos/ha_radar.png (карточка HA). Вставьте их в соответствующие места.
